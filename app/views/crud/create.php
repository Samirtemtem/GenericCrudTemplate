...
<head>
    <meta charset="UTF-8">
    <title>Create <?php echo ucfirst($tableName); ?> Record</title>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3">
                        <h2>Create <?php echo ucfirst($tableName); ?> Record</h2>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <form action="index.php?controller=<?php echo $model::getTableName(); ?>&action=create" 
                                  method="post" 
