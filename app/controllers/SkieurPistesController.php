...
use App\Models\SkieurPistesModel;

/**
 * Generated controller class for SkieurPistes
 */
class SkieurPistesController extends CrudController {
    protected $modelClass = SkieurPistesModel::class;
